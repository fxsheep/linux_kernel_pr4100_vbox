...
static void rtl8168g_1_hw_phy_config(struct rtl8169_private *tp)
{
  ...
  if (eee_enable) {
		rtl_w0w1_eri(tp, 0x1b0, ERIAR_MASK_1111, 0x03, 0x00, ERIAR_EXGMAC);
		rtl_writephy(tp, 0x1f, 0x0a43);
		rtl_w0w1_phy(tp, 0x11, 0x0010, 0x0000);
		rtl_writephy(tp, 0x1f, 0x0a5d);
		rtl_writephy(tp, 0x10, 0x0006);
		rtl_writephy(tp, 0x1f, 0x0000);
	} else {
		rtl_w0w1_eri(tp, 0x1b0, ERIAR_MASK_1111, 0x00, 0x03, ERIAR_EXGMAC);
		rtl_writephy(tp, 0x1f, 0x0a43);
		rtl_w0w1_phy(tp, 0x11, 0x0000, 0x0010);
		rtl_writephy(tp, 0x1f, 0x0a5d);
		rtl_writephy(tp, 0x10, 0x0000);
		rtl_writephy(tp, 0x1f, 0x0000);
	}
...
static void rtl_shutdown(struct pci_dev *pdev)
{
	...
	/* ALPHA_CUSTOMIZE remove , Because bonding mode lan 2 wol fail */
...
static int rtl_init_one(struct pci_dev *pdev, const struct pci_device_id *ent)
{
	...
	tp->rtl_fw = RTL_FIRMWARE_UNKNOWN;
//Jack20160108 modify for change ethx to egigax
  strcpy(dev->name, "egiga%d");
